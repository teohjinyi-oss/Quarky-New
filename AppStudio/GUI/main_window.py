...
from AppStudio.GUI.title_bar import TitleBar
from AppStudio.GUI.chat_panel import ChatPanel
from AppStudio.GUI.sidebar import Sidebar
from AppStudio.GUI.voice_overlay import VoiceOverlay
from AppStudio.GUI.toast import ToastContainer
from AppStudio.GUI.tray import TrayIcon
...
class _BackendWorker(QObject):
    ...
    def start_voice(self):
        ...
        if self._orch is None:
            ...
            return
        try:
            from AppStudio.Voice.pipeline import VoiceState
