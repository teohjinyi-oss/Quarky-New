...
class Orchestrator:
    ...
    def boot(self) -> list[str]:
        ...
        try:
            ...
            from core.nlp import spell_check as _spell_mod
            from core.nlp.entity_extractor import EntityExtractor
            from core.nlp import classifier as _nlp_cls_mod
        ...
        try:
            ...
            from core.routing.forwarder import Forwarder
            from core.decision import output_gate as _output_gate_mod
        ...
        # 6. Session
        try:
            from core.session.session_v2 import get_session_v2
    ...
    def start_voice(self) -> bool:
        ...
        try:
            from interfaces.voice.pipeline import VoicePipeline
