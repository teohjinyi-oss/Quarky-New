...
class AdaptiveResearcher:
    ...
    def _init_components(self):
        try:
            from MAIINNN.Functions.web.search import WebSearch
            self._search = WebSearch()
        except Exception:
            pass
        try:
            from MAIINNN.Functions.web.scraper import WebScraper
            self._scraper = WebScraper()
        except Exception:
            pass
        try:
            from MAIINNN.Functions.web.summarizer import TextSummarizer
